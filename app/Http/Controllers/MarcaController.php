...
class MarcaController extends Controller
{
    ...
    {
        //DEVUELVE UNA LISTA DE LOS REGISTRO GUARDADOS
    ...
    public function store(Request $request)
    {
       ...
       try {
        ...
        if ($marca->save() >= 1) {
            return response()->json(['status' => 'ok', 'data' => $marca, 'message' => 'Marca registrada'], 201);
        }else{
            return response()->json(['status' => 'fail', 'data' => $marca, 'message' =>'La marca no pudo ser registrada'], 409);
        }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            //devolviendo codigo y detalles de excepcion
            return $e->getMessage();
        }
    }
}
